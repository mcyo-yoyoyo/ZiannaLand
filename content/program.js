(function () {
  const media = {
    fox:{file:'Desert_Kit_Fox_(Vulpes_macrotis_arsipus).webm',src:'https://upload.wikimedia.org/wikipedia/commons/3/3c/Desert_Kit_Fox_%28Vulpes_macrotis_arsipus%29.webm',page:'https://commons.wikimedia.org/wiki/File:Desert_Kit_Fox_(Vulpes_macrotis_arsipus).webm',credit:'U.S. Fish and Wildlife Service / NCTC',license:'Public domain'},
    bird:{file:"Anna's_hummingbird_(Calypte_anna)_in_the_rain.webm",src:'https://upload.wikimedia.org/wikipedia/commons/e/e3/Anna%27s_hummingbird_%28Calypte_anna%29_in_the_rain.webm',page:'https://commons.wikimedia.org/wiki/File:Anna%27s_hummingbird_(Calypte_anna)_in_the_rain.webm',credit:'Love Star Production',license:'CC0'},
    clouds:{file:'Clouds_time_lapse.webm',src:'https://upload.wikimedia.org/wikipedia/commons/9/9f/Clouds_time_lapse.webm',page:'https://commons.wikimedia.org/wiki/File:Clouds_time_lapse.webm',credit:'John Fowler',license:'CC BY 2.0'},
    rainbow:{file:'Lightnings_and_rainbow.webm',src:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Lightnings_and_rainbow.webm',page:'https://commons.wikimedia.org/wiki/File:Lightnings_and_rainbow.webm',credit:'Cristian Bulumac',license:'CC BY 3.0'},
    seeds:{file:'Sabzeh_sprouting_seeds_timelapse.webm',src:'https://upload.wikimedia.org/wikipedia/commons/transcoded/c/cc/Sabzeh_sprouting_seeds_timelapse.webm/Sabzeh_sprouting_seeds_timelapse.webm.360p.webm',page:'https://commons.wikimedia.org/wiki/File:Sabzeh_sprouting_seeds_timelapse.webm',credit:'Always Shooting',license:'CC BY 2.0'},
    lettuce:{file:'Timelapse_of_lettuce_emerging.webm',src:'https://upload.wikimedia.org/wikipedia/commons/f/f6/Timelapse_of_lettuce_emerging.webm',page:'https://commons.wikimedia.org/wiki/File:Timelapse_of_lettuce_emerging.webm',credit:'Dwight Sipler',license:'CC BY 2.0'},
    moon:{file:'Moon_(30549457916).webm',src:'https://commons.wikimedia.org/wiki/Special:Redirect/file/Moon_(30549457916).webm',page:'https://commons.wikimedia.org/wiki/File:Moon_(30549457916).webm',credit:'Joshua Tree National Park / NPS Lian Law',license:'Public domain'},
    astronaut:{file:'Bunny_hopping_on_the_Moon.webm',src:'https://upload.wikimedia.org/wikipedia/commons/0/0b/Bunny_hopping_on_the_Moon.webm',page:'https://commons.wikimedia.org/wiki/File:Bunny_hopping_on_the_Moon.webm',credit:'NASA / Gene Cernan',license:'Public domain'}
  };
  const seeds = [
